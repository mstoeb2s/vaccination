...
const apiUrl = "https://raw.githubusercontent.com/owid/covid-19-data/master/public/data/vaccinations/country_data/Ireland.csv"
...
const list = new ListWidget()
  ...
  const header2 = list.addText("        Ireland".toUpperCase())
...
var impfGes_pro = impfGes/4904000*100;
